...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    if(null !==(['submit'])){
        ...
        $sql="INSERT INTO `student_registration`(`redgno`, `selectcourse`, `Majorsubject1`, `Majorsubject2`, `firstname`, `lastname`, `gender`, `parentsname`, `parentsoccupation`, `nationality`, `physically`, `mobileno`, `email`, `country`, `city`, `permanentaddress`, `board10`, `gpa10`, `board12`, `gpa12`) VALUES ('','$selectcourse','$subject1','$subject2','$firstname','$lastname','$gender','$parentsname','$parentsoccupation','$nationality','$physical','$mobile','$email','$country','$city','$address','$board1','$result1','$board2','$result2')";
        ...
        if($record){
            ...
            echo "not submitted, something is invalid......!";
        }
    }
}
?>
