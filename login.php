    ...
    <div class="box my-5">
        ...
        <div class="container my-5">
            <form method="post">
                ...
                <button type="submit" class="btn btn-primary" name="signup">Login</button><br>
                <button type="submit" class="btn btn-primary" name="signup"><a href="signup.php" class="text-dark">Signup</a></button>
            </form>
        </div>
    </div>
</body>
